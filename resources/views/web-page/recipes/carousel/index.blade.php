            ...
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-primary mb-1 mb-md-0" data-bs-toggle="modal"
                        data-bs-target="#varyingModal" data-bs-whatever="@getbootstrap">Add Carousel</button>
                                ...
                                @foreach ($carousels as $carousel)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="edit" data-item="{{ $carousel }}"
                                                data-updateurl="{{ route('carousel-update', $carousel->id) }}"
                                                data-updateimage="{{ getImage($carousel->image) }}"><i class="action-icon"
                                                    data-feather="edit"></i></a>

                                            <a href="#" class="deleteItem"
                                                data-formid="delete_form_{{ $carousel->id }}" title="delete"><i
                                                    class="action-icon" data-feather="trash-2"></i></a>
                                            <form action="{{ route('carousel-delete', $carousel->id) }}" method="post"
                                                id="delete_form_{{ $carousel->id }}">
                                                @csrf
                                                @method('delete')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('add.carousel')}}" class="forms-sample" method="post" enctype="multipart/form-data">
                        @csrf
                      
                        <div class="row mb-3">
                            <label for="carousel_name" class="col-sm-3 col-form-label">Carousel Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('image_name') is-invalid @enderror" id="carousel_name" name="image_name" placeholder="Carousel name"
                                    value="">
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form id="form_action" action="" class="forms-sample" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="carousel_name" class="col-sm-3 col-form-label">Carousel Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="carousel_name" name="image_name" placeholder="Title"
                                    value="">
                            </div>
                        </div>
    ...
    <script>
        $(function() {
            ...
            $('.edit').on('click', function(e) {
                ...
                modal.find('input[name=image_name]').val($(this).data('item').image_name)
